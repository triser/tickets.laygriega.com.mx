...
<html>
    ...
    <body class="hold-transition skin-blue sidebar-mini">
        <?php
            $WhiteList=["administrador","asesor-externo","usuarios","alta-usuario","config","edit-usuario","perfil","edit-perfil","actualizacion-cuenta","bajauser","tickets","alta-ticket","asunto-ticket","alta-asunto","alta-asunto-ticket","baja-asunto-ticket","tickets-recibidos","tickets-enviados"];
